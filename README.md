...
When you activate a plugin generated by WP-Autoplugin, it will automatically detect fatal errors and deactivate itself to prevent your site from crashing. It will also offer you the option to fix the error automatically.
