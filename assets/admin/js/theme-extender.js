    ...
    if (themeSlug) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                if (hooks.length > 0) {
                    hooksSummary.textContent = wp_autoplugin.messages.hooks_found_in_theme.replace('%d', hooks.length);
                    ...
                    hooksSummary.textContent = wp_autoplugin.messages.no_theme_hooks_found;
                    hooksUl.innerHTML = '';
                    hooksContent.style.display = 'block';
                }
            } else {
