		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					...
					<input type="hidden" name="wp_autoplugin_custom_models" id="wp_autoplugin_custom_models" value="<?php echo esc_attr( json_encode( get_option( 'wp_autoplugin_custom_models', [] ) ) ); ?>">
